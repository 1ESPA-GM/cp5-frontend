function Hero() {
    return (
      <section className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-20 text-center">
        ...
        <div className="mt-10">
          <img src="/demo-app.png" alt="Demonstração do App" className="mx-auto rounded-lg shadow-2xl max-w-md" />
        </div>
      </section>
    )
  }
